...
public class AdminTripController {
    ...
    public String list(Model model,@RequestParam Map<String, String> params) {
        ...
        System.out.println(tripSer.getAllTrip(params).size());
    ...
    public String tripDetail(Model model, @PathVariable(value = "id") long id) {
        model.addAttribute("routes", this.routeSer.getAllRoute());
    ...
    public String addTripToDB(Model model, @ModelAttribute(value = "trip") @Valid Trip t, BindingResult result) throws ParseException, Exception {
